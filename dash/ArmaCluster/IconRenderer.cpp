...
void IconRenderer::doRender()
{
	...
	// door ajar icon
	glViewport(296 - 200, 632 - 2 /* adjust lower */, 50, 56); // 
...
void IconRenderer::drawTellTale()
{
	glBegin(GL_QUADS);
...
void IconRenderer::keyPressed(int key)
{
