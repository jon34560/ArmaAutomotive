...
public class ModellingApp
{
  ...
  {
    List instances = PluginRegistry.getPlugins(armadesignstudio.procedural.Module.class);
    Class classes[] = new Class[instances.size()];
    for (int i = 0; i < classes.length; i++)
      classes[i] = instances.get(i).getClass();
    return classes;
  ...
  public static void registerModule( armadesignstudio.procedural.Module o)
  {
    PluginRegistry.registerPlugin(o);
  }
