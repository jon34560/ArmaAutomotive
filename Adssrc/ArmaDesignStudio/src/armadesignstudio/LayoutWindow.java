  ...
  */
  ...
  public void setGCodeExportScale(){
	try {
		...
		String dir = theScene.getDirectory() + System.getProperty("file.separator") + theScene.getName() + "_layout_data";
		File d = new File(dir);
		if(d.exists() == false){
			d.mkdir();
		}
		dir = dir + System.getProperty("file.separator") + "scale.properties";
		d = new File(dir);
		if(d.exists() == false){
		...
		String answer = JOptionPane.showInputDialog(myFrame,
				 ...
				 "GCode Export Scale", JOptionPane.INFORMATION_MESSAGE, null, null,  "1"); // Double.toString(scale) +
		*/
		String answer = JOptionPane.showInputDialog(
						 "Enter an export scale factor", Double.toString(scale));
