...
package armadesignstudio.script;
...
public class ScriptRunner
{
  ...
  private static final String IMPORTS[] = {"armadesignstudio.*", "armadesignstudio.image.*", "armadesignstudio.material.*",
      "armadesignstudio.math.*", "armadesignstudio.object.*", "armadesignstudio.script.*", "armadesignstudio.texture.*",
      "armadesignstudio.ui.*", "buoy.event.*", "buoy.widget.*"};
